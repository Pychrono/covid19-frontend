    ...
    return (
      <section>
        <div className="bg-white border border-gray-200 rounded-2xl shadow-xl p-8 max-w-7xl mx-auto">
          ...
          {/* Legend */}
          <div className="text-sm text-gray-600 mt-4 grid grid-cols-2 sm:grid-cols-3 gap-2">
            <p>
              <span className="inline-block w-4 h-4 rounded bg-[#ffffcc] mr-2"></span>
              0–100k cases
            </p>
            <p>
              <span className="inline-block w-4 h-4 rounded bg-[#ffcc00] mr-2"></span>
              100k–500k cases
            </p>
            <p>
              <span className="inline-block w-4 h-4 rounded bg-[#ff9933] mr-2"></span>
              500k–1M cases
            </p>
            <p>
              <span className="inline-block w-4 h-4 rounded bg-[#ff6600] mr-2"></span>
              1M–20M cases
            </p>
            <p>
              <span className="inline-block w-4 h-4 rounded bg-[#cc0000] mr-2"></span>
              20M–40M cases
            </p>
            <p>
              <span className="inline-block w-4 h-4 rounded bg-[#660000] mr-2"></span>
              40M–80M+ cases
            </p>
          </div>
        </div>
